...
using namespace std;
class Item // creating class Items
{
public:
    char name[10];
    int quantity;
...
int main()
{
    ...
    do
    {
        ...
        case 4:
            sort(o1.begin(), o1.end(), compare); // under algo
            cout << "\n\n Sorted on Cost : ";
            display();
            break;
...
void display()
{                                          // Item i1;
    for_each(o1.begin(), o1.end(), print); // for_each - it is loop under algorithm header file
}
void print(Item &i1)
{
    cout << "\n";
...
void search()
{
    vector<Item>::iterator p; // syntax to create iterator
    Item i1;
    cout << "\nEnter Item Code to search : ";
    cin >> i1.code;
    p = find(o1.begin(), o1.end(), i1); // under algorithm
    if (p == o1.end())
    {
        cout << "\nNot found!!!";
    }
